    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (err.response && err.response.data) {
                // Extract first error message from values (which might be arrays)
                const messages = Object.values(err.response.data).flat();
                setError(messages[0] || "Registration failed.");
            } else {
                setError("Registration failed. Check network or console.");
            }
        }
    };
                        ...
                        <div>
                            <div className="relative">
                                <input
                                    ...
                                    required
                                    className="appearance-none rounded-none relative block w-full px-3 py-2 border border-slate-300 placeholder-slate-500 text-slate-900 rounded-b-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm pr-10"
